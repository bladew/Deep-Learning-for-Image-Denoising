...
import pretrain1, pretrain2, pretrain3, pretrain4, pretrain5
import train_utils
...
if __name__ == "__main__":
	...
	pretrain3.train(images, 'models/model-2')
	restore_path3 = pretrain3.save()
	
	pretrain4.train(images, restore_path3)
	restore_path4 = pretrain4.save()

	#pretrain5.train(images, restore_path4)
	#restore_path5 = pretrain5.save()
'''
